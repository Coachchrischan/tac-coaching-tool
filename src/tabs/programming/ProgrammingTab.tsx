...
import { weekEmailBody, weekEmailSubject } from '../../lib/weekEmail';
...
export default function ProgrammingTab() {
  ...
  // Everything the Week view (the daily editing surface, its own file) needs.
  const weekViewProps = {
    session,
    sessions,
    blocks,
  ...
  return (
    <div onKeyDown={handleKeyDown}>
      ...
      {view === 'week' && <WeekView {...weekViewProps} />}
      </div>
      </div>
    </div>
  );
